        ...
        <div className={headerContainer} style={{ border: "2px solid red" }}>
            ...
            <ul className={contactNav}>
                <IconContext.Provider value={{ size: "1.3rem" }}>
                    <li>
                        <a href="mailto:rahikhan360@gmail.com" target="_blank" className={navItem}>
                            <HiOutlineMail />
                    ...
                    <li>
                        <a href="https://rahikhan.gtsb.io/" target="_blank" className={navItem}>
                            <HiOutlineHome />
                            <span className={contacts}>rahikhan.gtsb.io</span>
                        </a>
                    </li>
                    <li>
                        <a href=" https://github.com/rahi-khan" target="_blank" className={navItem}>
                            <FiGithub />
